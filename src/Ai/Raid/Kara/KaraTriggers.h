...
{
public:
    KarazhanChessPieceNeedsControllerTrigger(PlayerbotAI* botAI)
        : Trigger(botAI, "karazhan chess piece needs controller") {}
    bool IsActive() override;
};
...
{
public:
    KarazhanControlledChessPieceInFireTrigger(PlayerbotAI* botAI)
        : Trigger(botAI, "karazhan controlled chess piece in fire") {}
    bool IsActive() override;
};
...
{
public:
    KarazhanFriendlyKingUnderThreatTrigger(PlayerbotAI* botAI)
        : Trigger(botAI, "karazhan friendly king under threat") {}
    bool IsActive() override;
};
...
{
public:
    KarazhanControlledChessPieceAbilityReadyTrigger(PlayerbotAI* botAI)
        : Trigger(botAI, "karazhan controlled chess piece ability ready") {}
    bool IsActive() override;
};
