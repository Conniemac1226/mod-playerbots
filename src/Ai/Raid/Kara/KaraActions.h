...
{
public:
    KarazhanChessMovePieceAction(PlayerbotAI* botAI, std::string const name = "karazhan chess move piece") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
...
{
public:
    KarazhanChessMoveOutOfFireAction(PlayerbotAI* botAI, std::string const name = "karazhan chess move out of fire") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
...
{
public:
    KarazhanChessUseAbilityAction(PlayerbotAI* botAI, std::string const name = "karazhan chess use ability") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
...
{
public:
    KarazhanChessHealFriendlyAction(PlayerbotAI* botAI, std::string const name = "karazhan chess heal friendly piece") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
...
{
public:
    KarazhanChessAttackEnemyKingAction(PlayerbotAI* botAI, std::string const name = "karazhan chess attack enemy king") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
...
{
public:
    KarazhanChessBlockEnemyPathAction(PlayerbotAI* botAI, std::string const name = "karazhan chess block enemy path") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
...
{
public:
    KarazhanChessReleaseOrReassignAction(PlayerbotAI* botAI, std::string const name = "karazhan chess release or reassign") : Action(botAI, name) {}
    bool Execute(Event event) override;
};
