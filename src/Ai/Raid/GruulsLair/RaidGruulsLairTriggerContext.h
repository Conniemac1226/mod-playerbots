...
public:
    RaidGruulsLairTriggerContext() : NamedObjectContext<Trigger>()
    {
        ...
        creators["high king maulgar blindeye casting"] = &RaidGruulsLairTriggerContext::high_king_maulgar_blindeye_casting;
        ...
        creators["gruuls lair auto pull ready"] = &RaidGruulsLairTriggerContext::gruuls_lair_auto_pull_ready;
        ...
        creators["gruul the dragonkiller cave in"] = &RaidGruulsLairTriggerContext::gruul_the_dragonkiller_cave_in;
...
private:
    ...
    static Trigger* high_king_maulgar_blindeye_casting(PlayerbotAI* botAI) { return new HighKingMaulgarBlindeyeCastingTrigger(botAI); }
    ...
    static Trigger* gruuls_lair_auto_pull_ready(PlayerbotAI* botAI) { return new GruulsLairAutoPullReadyTrigger(botAI); }
    ...
    static Trigger* gruul_the_dragonkiller_cave_in(PlayerbotAI* botAI) { return new GruulTheDragonkillerCaveInTrigger(botAI); }
