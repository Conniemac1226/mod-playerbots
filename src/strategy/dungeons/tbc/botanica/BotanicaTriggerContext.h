...
private:
    ...
    static Trigger* laj_adds(PlayerbotAI* botAI) { return new LajAddsTrigger(botAI); }
    ...
    static Trigger* warp_splinter_saplings(PlayerbotAI* botAI) { return new WarpSplinterSaplingsTrigger(botAI); }
};
