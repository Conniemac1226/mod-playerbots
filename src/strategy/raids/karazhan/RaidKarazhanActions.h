...
class KarazhanChessEventMoveAction : public MovementAction
{
public:
    KarazhanChessEventMoveAction(PlayerbotAI* botAI, std::string const name = "karazhan chess event move") : MovementAction(botAI, name) {}
